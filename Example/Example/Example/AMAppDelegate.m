...
@interface AMAppDelegate() <AdlibClientDelegate>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [adlibClient startWithAppId:@"100045" delegate:self];
    [adlibClient setAge:nil];
    [adlibClient setGender:AMDemographicsGenderFemale];
